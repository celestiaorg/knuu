...
require (
	...
	github.com/chaos-mesh/chaos-mesh/api v0.0.0-20240620063607-a71476b644a3
...
replace github.com/celestiaorg/celestia-node => github.com/renaynay/celestia-node v0.9.3-0.20240517121037-d07533b09ebd
