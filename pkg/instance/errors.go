...
var (
	...
	ErrSettingCommand                            = errors.New("SettingCommand", "setting command is only allowed in state 'Preparing'. Current state is '%s")
	ErrSettingArgsNotAllowed                     = errors.New("SettingArgsNotAllowed", "setting args is only allowed in state 'Preparing'. Current state is '%s")
	ErrAddingPortNotAllowed                      = errors.New("AddingPortNotAllowed", "adding port is only allowed in state 'Preparing'. Current state is '%s")
	...
	ErrSettingMemoryNotAllowed                   = errors.New("SettingMemoryNotAllowed", "setting memory is only allowed in state 'Preparing'. Current state is '%s")
	ErrSettingCPUNotAllowed                      = errors.New("SettingCPUNotAllowed", "setting cpu is only allowed in state 'Preparing'. Current state is '%s")
